...
- Name: admin/projects.spec.ts >> Admin — Projects >> should edit the most recent project and show the update success toast
- Location: tests/admin/projects.spec.ts:96:7
